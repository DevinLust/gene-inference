...
public class NaiveInferenceTest {
    private NaiveInference naiveInference;

    @BeforeEach
    void setUp() {
        naiveInference = new NaiveInference();
    }
    ...
    void testFindJointDistribution() {
        ...
        // Act
        naiveInference.findJointDistribution(relationship);
    ...
    void testUpdateMarginalDistribution() {
        ...
        // Act
        naiveInference.updateMarginalProbabilities(relationship);
    ...
    void testInferChildDistributionChild1() {
        ...
        // Act
        Map<Grade, Double> childDistribution = naiveInference.inferChildHiddenDistribution(relationship, Grade.D);
    ...
    void testInferChildDistributionChild2() {
        ...
        // Act
        Map<Grade, Double> childDistribution = naiveInference.inferChildHiddenDistribution(relationship, Grade.C);
    ...
    private Sheep createTestSheep(Grade phenotype, Map<Grade, Double> hiddenDistribution) {
